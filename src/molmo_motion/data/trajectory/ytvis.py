"""YT-VIS trajectory dataset — extracted verbatim from the monolithic
`trajectory_3d_dataset.py` (the `ds == "ytvis"` branches).
"""
...
class YTVisDataset(BaseTrajectoryDataset):
    """YT-VIS: dict-format NPZ tracks keyed by object cluster name (e.g. 'parrot_0')."""
