...
from molmo_motion.data.types import PointTrack
...
class LegacyPointFormatting(PointFormatter):
    ...
    def extract_tracks(cls, text, width, height, video_fps, format=None):
        from molmo_motion.eval.point_tracking_utils import PointTrackingParser
        from molmo_motion.eval.object_tracking_utils import ObjectTrackingParser
