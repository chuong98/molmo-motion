...
from molmo_motion.models.model import ModelBase
...
def get_model_types() -> Dict[str, Type['BaseModelConfig']]:
    ...
    from molmo_motion.models.molmo_point.molmo_point import MolmoPointConfig

    return {
        MolmoConfig._model_name: MolmoConfig,
        Molmo2Config._model_name: Molmo2Config,
        Molmo2TrajectoryConfig._model_name: Molmo2TrajectoryConfig,
