...
from molmo_motion.models.molmo_point.molmo_point_data_formatter import Message
from molmo_motion.preprocessing.text_preprocessor import MessageWeight, build_subsegment_pos_ids
