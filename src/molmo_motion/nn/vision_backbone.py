...
from molmo_motion.config import BaseConfig, D, StrEnum
from molmo_motion.nn.cp_load_balancer import CPLoadBalancerType, CPLoadBalancer
from molmo_motion.nn.image_vit import VitConfig, VisionTransformer
from molmo_motion.nn.llm import Activation
from molmo_motion.preprocessing.image_preprocessor import ImagePreprocessor
from molmo_motion.torch_util import freeze_module
...
class MolmoVisionBackbone(nn.Module):
    ...
    def build_connector(self, llm_config, device):
        ...
        from molmo_motion.nn.image_vit import ViTMultiHeadDotProductAttention
